...
<template>
  <div class="flex min-h-screen items-center justify-center bg-slate-100">
    <div class="w-full max-w-sm rounded-lg bg-white p-8 shadow-sm">
      <h1 class="mb-1 text-xl font-semibold text-slate-900">GeoFleet Driver</h1>
      <p class="mb-6 text-sm text-slate-500">Create a driver account.</p>
      ...
      <form class="space-y-4" @submit.prevent="onSubmit">
        ...
        <div>
          <label for="license" class="mb-1 block text-sm font-medium text-slate-700">Driving license number</label>
          <input
            id="license"
        ...
        <div>
          <label for="license-expiry" class="mb-1 block text-sm font-medium text-slate-700">License expiry date</label>
          <input
            id="license-expiry"
            v-model="licenseExpiresAt"
            type="date"
            required
            class="w-full rounded-md border border-slate-300 px-3 py-2 text-sm focus:border-slate-500 focus:outline-none"
          >
